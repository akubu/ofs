    ...
    <div class="row">
        ...
        <div class="col-md-11 no_padding">
            <div class="col-md-12 no_padding">
                ...
                <div class="add_bar">
                    <a class="add_sme_link" href="javascript:void(0)"><i class="fa fa-dashboard"></i> Manage DC</a>
                    <span style="float: right; padding-right: 15px">
                        <button id="generate_dc" class="btn btn-md red" style="width: auto">Print DC</button>
                    </span>
                    <span style="float: right; padding-right: 10px">
                        <button id="generate_dc" class="btn btn-md red" style="width: auto">Cancel DC</button>
                    </span>
                    <span style="float: right; padding-right: 10px">
                        <a href="/dc_create" >
                        <button id="generate_dc" class="btn btn-md red" style="width: auto" >Create DC</button>
                        </a>
                    </span>
                </div>
