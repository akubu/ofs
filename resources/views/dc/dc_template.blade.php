                                    ...
                                    <tr>
                                        <td width="40%">
                                            <div class="col-md-12 logoDiv">
                                                <a href="#"><img src="imgs/logo_nDC.png" alt="Power2Sme"></a>
...
Please receive the undermentioned goods order and sound condition and return the DUPLICATE COPY duly signed with your rubber stamp.</span>
                                            ...
                                            <td width="50%">
                                                <div class="col-md-8 col-md-offset-4  ">
                                                    ...
                                                    <div class="dc_details">
                                                        ...
                                                        <p>
                                                            <span>Order Date :</span> 02 March 2016<br>
                                                            <span>Order # </span>292314 <br>
                                                            <span>Challan Number :</span> 285<br>
                                                            <span>Challan Date :</span> 03 March 2016<br>
                                        ...
                                        <td width="50%">
                                            ...
                                            <div class="col-md-12 address_panel">
                                                ...
                                                <div class="address_box" style=" border: 1px solid #ddd !important;">
                                                    ...
                                                    <p>CMDA Truck terminal, C-6, Madhavaram, Chennai -110</p>

                                                    <p>
                                                        <span>TIN :</span> 33401089327<br>
                                                        <span>CST :</span> 1210974 / Date:13.02.2014<br>
                                                        <span>CIN No.:</span> U74900DL2012PTC230723
                                                    </p>

                                                    <p><span>Regd. Office :</span> 406-A Indraprastha Towers,6, Commercial Complex,
                                                        Wazirpur, New Delhi - 110052.</p>
                                        ...
                                        <td width="50%">
                                            <div class="col-md-12 address_panel">
                                                ...
                                                <div class="address_box" style=" border: 1px solid #ddd !important;">
                                                    ...
                                                    <p class="box_head">Bhuvana Ploymenrs Pvt Ltd</p>
                                                    <p>F13 - F16, Sipcot, Industrial Estate, Manamadurai -630606</p>

                                                    <p>
                                                        <span>TIN :</span> 33401089327<br>
                                                        <span>CST :</span> 499357 / Date:13.02.2014<br>
                            ...
                            <div class="invoice">
                                ...
                                <table class="table invoice_table">
                                    ...
                                    <tr>
                                        <td><strong>1.</strong> Steel, Mild Steel (MS) Hot Rolled (HR) sheet, OTHER NICKLE JT SHEET</td>
                                        <td>1000 MT</td>
                                    ...
                                    <tr class="border">
                                        <td><strong>2.</strong> Steel, Mild Steel (MS) Hot Rolled (HR) sheet, OTHER NICKLE JT SHEET</td>
                                        <td>1000 MT</td>
                                        <td><span class="fa fa-rupee"></span> 89MT</td>
                                        <td class="text-right"><span class="fa fa-rupee"></span> 89,000</td>
                                    </tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="address_box">
                                                                    ...
                                                                    <p class="box_head">Lorry /Vehicle No. : DL 10PG 3256 </p>
                                                                    <p>
                                                                        <span>Note :</span><br>
