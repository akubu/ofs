...
use App\BEBBlocations;
use Illuminate\Console\Command;
use Log;

class getBEBBNos extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'navision:getBEBBNos';
    ...
    public function handle()
    {
        ...
        $nav_locations = BEBBlocations::all();

        Log::info("Master locations count : "  .$nav_locations->count() . "\n");
